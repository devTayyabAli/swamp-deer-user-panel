...
export default function ResetPassword() {
    ...
    if (!token) {
        return (
            <div className="flex min-h-screen items-center justify-center bg-neutral-light p-6">
                <div className="max-w-md w-full text-center space-y-6 bg-white p-12 rounded-[32px] border border-red-100 shadow-xl shadow-red-50">
                    <div className="w-20 h-20 bg-red-50 text-red-500 rounded-3xl flex items-center justify-center mx-auto mb-6">
                        <Lock className="w-10 h-10" />
                    </div>
                    <h2 className="text-2xl font-black text-gray-900">Invalid Reset Link</h2>
                    <p className="text-gray-500 font-medium">This password reset link is invalid or has expired. Please request a new one.</p>
                    <button
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 mt-8">
                        <div className="space-y-4">
                            <div className="group space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full pl-11 pr-12 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-medium"
                                        placeholder="••••••••"
                                    />
                                    <button
                                        type="button"
                            ...
                            <div className="group space-y-1">
                                ...
                                <div className="relative">
                                    <CheckCircle2 className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors" />
                                    <input
                                        type="password"
                                        required
                        ...
                        <ul className="space-y-2 ml-1">
                            ...
                            <li className="flex items-center gap-2 text-xs font-bold text-gray-400">
                                <div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Must include a symbol
                            </li>
                        </ul>
